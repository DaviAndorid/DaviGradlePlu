...
public class plu_start_activity_AMSHookHelper {
    ...
    public static void hookAMN() throws ClassNotFoundException,
        ...
        Object gDefault = RefInvoke.getStaticFieldObject("android.app.ActivityManagerNative",
                "gDefault");
        ...
        Object proxy = Proxy.newProxyInstance(
                ...
                new plu_start_activity_MockClass1(mInstance));
    ...
    public static void hookActivityThread() throws Exception {
        ...
        Handler mH = (Handler) RefInvoke.getFieldObject(currentActivityThread,
                "mH");

        //把Handler的mCallback字段，替换为new MockClass2(mH)
        RefInvoke.setFieldObject(Handler.class, mH, "mCallback",
                new plu_start_activity_MockClass2(mH));
    }
